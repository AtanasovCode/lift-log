...
const ExerciseSelect = () => {
    ...
    return (
        <DropdownWrapper>
            ...
            <DropdownHeader>Select an exercise</DropdownHeader>
            ...
            <DropdownSearch>
                ...
                <FilterTabs>
                    ...
                    >
                        <FilterOption value="any">Any body part</FilterOption>
                        {bodyParts.map((x) => (
                            <FilterOption value={x} key={x}>
                                {x}
                            </FilterOption>
                        ))}
                    </Filter>
            ...
            <DropdownList>
                {filteredOptions.map((exercise) => (
                    ...
                    >
                        ...
                        />
                        <DropdownText>
                            <DropdownExercise>{exercise.name}</DropdownExercise>
                            <DropdownCategory>{exercise.category}</DropdownCategory>
                        </DropdownText>
                    </DropdownItem>
                ))}
            </DropdownList>
